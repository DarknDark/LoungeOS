...
Firestore/Auth initialization or repository verification can begin. The
workspace does not have a managed Firebase integration, so do not substitute
...
`FIREBASE_PRIVATE_KEY` as required server secrets. Treat
